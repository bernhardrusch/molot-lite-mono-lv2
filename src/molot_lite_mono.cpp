...
void MolotLiteMono::UpdateParameters()
{
	register double			val;
 ...
 * store them in variables you add to your MolotLiteMono
...
MolotLiteMono::MolotLiteMono(double sampleRate)
{
}
...
MolotLiteMono::~MolotLiteMono(void)
{
}
...
void MolotLiteMono::pluginActivate()
{
	m_comp.reset();
...
void MolotLiteMono::pluginDeActivate()
{
	pluginActivate();
}
